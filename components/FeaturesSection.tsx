  ...
  return (
    <section id="features" className="py-8 lg:py-16 bg-background">
      <div className="container mx-auto px-2 sm:px-4 lg:px-4">
        ...
        <div className="flex gap-8 items-start justify-between mb-32">
          {/* Left: Feature descriptions */}
          <div className="text-start mb-16 animate-fade-in w-[40%]">
          ...
          <div className="grid grid-cols-2 gap-4">
            {truckImages.map((truck, index) => (
              <div
                key={index}
                className="truck-hover rounded-xl overflow-hidden shadow-lg w-[25vw] h-24 bg-[length:100%_100%] bg-no-repeat flex"
